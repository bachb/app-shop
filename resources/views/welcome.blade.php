...
@section('styles')
    <style>
        ...
        /*Hace que todas las colomnas tengan el mismo tamaño*/
        .row {
            display: -webkit-box;
            display: -webkit-flex;
            display: -ms-flexbox;
...
<div class="main main-raised">
    <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Atendemos rápidamente cualquier consulta que terngas vía chat.No estás solo, sino que siempre estamos atentos a tus inquietudes.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                    ...
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Los pedidos que realices sólo los conocerás tú a través de tu panes de usuario.Nadie más tiene acceso a esta infomación.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section landing-section">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="text-center title">¿Aún no te has registrado?s</h2>
